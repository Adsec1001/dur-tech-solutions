            ...
            <CardContent className="pt-6 pb-6">
              <div className="flex flex-col sm:flex-row items-center gap-6">
                ...
                <div className="flex-1 text-center sm:text-left">
                  <h3 className="text-xl font-bold text-foreground mb-1">WhatsApp Kanalımıza Katılın</h3>
                  <p className="text-muted-foreground text-sm mb-3">
                    Güncel kampanyalar, teknoloji haberleri ve özel fırsatlardan anında haberdar olun. Kanalımıza katılarak hiçbir fırsatı kaçırmayın!
                  </p>
                  <a
