          ...
          <Card className="border-primary/20 bg-gradient-to-br from-primary/5 via-background to-primary/10 overflow-hidden relative">
            <CardContent className="pt-6 pb-6">
              <div className="flex flex-col sm:flex-row items-center gap-6">
                <div className="w-16 h-16 rounded-2xl bg-[hsl(142,70%,45%)] flex items-center justify-center shrink-0 shadow-lg">
                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-[hsl(142,70%,45%)] text-white font-medium text-sm hover:bg-[hsl(142,70%,40%)] transition-colors shadow-md"
                  >
